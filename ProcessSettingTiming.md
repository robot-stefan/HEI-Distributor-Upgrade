...
### Solo Approach:
The approach I used without an assistant available to set timing as the car is revved up to 3k rpm, was to look at total timing at idle and try to get to that to line up as best I could.
...
4. Connect vac line to manifold port on the carb and vac port on distributor. Then crank car. 
...
7. Be sure to check position of the idle stop solenoid screw this also sets idle speed.

Switching to ported vac from manifold once timing is settled. I have Seen arguments for either vac advance setup.
